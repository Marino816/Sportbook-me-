...
export default function RefundPolicyPage() {
  return (
    <LegalPage title="Refund & Cancellation Policy" lastUpdated="September 25, 2026">
      <P>
      ...
      <UL>
        ...
        <LI><strong style={{ color: "#f0f6fc" }}>Pro Arena</strong> — {WEBSITE_PRICE_DISPLAY.proMonthlyLegal} or {WEBSITE_PRICE_DISPLAY.proAnnualLegal}. Includes expanded analytical features.</LI>
        <LI><strong style={{ color: "#f0f6fc" }}>Elite Stack</strong> — {WEBSITE_PRICE_DISPLAY.eliteMonthlyLegal} or {WEBSITE_PRICE_DISPLAY.eliteAnnualLegal}. Includes all available features.</LI>
      </UL>
