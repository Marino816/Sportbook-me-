      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-sm mt-2" style={{ color: "#8b949e" }}>
            Unlock AI-powered DFS projections and optimization
          </p>
        </div>
        ...
        >
          <div>
            <label className="block text-xs font-bold uppercase tracking-wider mb-2" style={{ color: "#8b949e" }}>
              Email
            </label>
            <div className="relative">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 size-4" style={{ color: "#8b949e" }} />
              <input
                type="email"
                required
                value={email}
          ...
          <div>
            ...
            <div className="relative">
              <Lock className="absolute left-3 top-1/2 -translate-y-1/2 size-4" style={{ color: "#8b949e" }} />
              <input
                type="password"
                required
                value={password}
