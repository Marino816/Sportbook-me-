...
const s = StyleSheet.create({
  scroll: { flex: 1, backgroundColor: "#0a0a0a" }, container: { padding: 20, gap: 16 },
  ...
  plan: { fontSize: 24, fontWeight: "900", color: "#4ade80", marginTop: 4, fontStyle: "italic" },
  ...
  planCard: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", backgroundColor: "#1a1a1a", borderRadius: 16, padding: 16, borderWidth: 1, borderColor: "#333" },
  planName: { fontSize: 16, fontWeight: "700", color: "#fff" }, planDesc: { fontSize: 13, color: "#888", marginTop: 2 },
  price: { fontSize: 16, fontWeight: "700", color: "#4ade80" },
  btn: { backgroundColor: "#4ade80", borderRadius: 12, padding: 16, alignItems: "center", marginTop: 8 },
